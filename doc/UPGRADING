...
If you want to upgrade to an alpha or beta version of IMP, you need to tell
...
If you want to upgrade from an IMP version prior to 5.0, please follow the
instructions in INSTALL_ to install the most recent IMP version using the PEAR
installer.
...
The following options have been removed::
   ...
   $conf['user']['allow_view_source'] (use 'view_msg_source' permission)
...
The format of hooks.php has changed.  See horde/doc/UPGRADING for more
information.
